...
## Corpus Check
- 64 files · ~22,526 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 524 nodes · 714 edges · 39 communities (35 shown, 4 thin omitted)
...
1. `LogcatCubit` - 17 edges
2. `DevKitDashboardCubit` - 16 edges
...
- `build` --references--> `LogcatCubit`  [EXTRACTED]
  lib/features/logcat/presentation/widgets/logcat_search_filter_widget.dart → lib/features/logcat/application/logcat_cubit.dart
- `ToolsCubit` --references--> `ToolsState`  [EXTRACTED]
  lib/features/tools/application/tools_cubit.dart → lib/features/tools/application/tools_state.dart
...
Cohesion: 0.07
Nodes (27): IconData, build, currentIndex, DevKitBottomNavigationBar, isPro, new, onTap, build (+19 more)
...
Cohesion: 0.06
Nodes (33): adbConnectCommand, ConsoleStateEntity, ConsoleStateEntityX, copyWith, deviceIp, deviceModel, devicePort, footnoteText (+25 more)
...
Cohesion: 0.19
Nodes (13): LogcatCubit, build, LogcatHeaderBarWidget, new, build, _getLogLevelColor, LogcatLevelFilterWidget, new (+5 more)
...
Cohesion: 0.25
Nodes (7): build, child, _neonGridMatrix, new, package:devkit/core/constant/app_assets.dart, static const ColorFilter, Widget

### Community 12 - "tools_screen_content_widget.dart"
Cohesion: 0.09
Nodes (24): selectTab, unlockPro, build, LogcatScreen, new, ToolsCubit, build, new (+16 more)

### Community 20 - "tools_screen.dart"
Cohesion: 0.12
Nodes (18): ConsoleNavigationCubit, ConsoleNavigationState, copyWith, currentNavIndex, isPro, new, build, DevKitConsoleScreen (+10 more)
...
Cohesion: 0.08
Nodes (33): DevKitDashboardCubit, consoleState, copyWith, DevKitDashboardState, new, build, DevKitDashboardView, new (+25 more)

### Community 24 - "device_info_service.dart"
Cohesion: 0.06
Nodes (31): dart:io, Future, brand, DeviceInfoData, _deviceInfoPlugin, DeviceInfoService, fallback, getDeviceInfo (+23 more)

### Community 25 - "package:devkit/core/theme/app_theme.dart"
Cohesion: 0.20
Nodes (9): animationScale, copyWith, gpuProfiling, new, showLayoutBounds, showPointerLocation, showTaps, strictMode (+1 more)
...
Cohesion: 0.25
Nodes (7): build, createState, dispose, _filterController, initState, new, TextEditingController

### Community 28 - "bottom_navigation.dart"
Cohesion: 0.29
Nodes (6): build, icon, label, new, onTap, package:flutter/material.dart
...
Cohesion: 0.40
Nodes (5): CyberGridBackground, QuickActionChipWidget, ToolsScreen, PaywallTierOptionCard, StatelessWidget
...
Cohesion: 0.20
Nodes (9): getLogs, LogcatLocalDataSource, LogcatLocalDataSourceImpl, new, getInitialLogs, localDataSource, new, package:devkit/features/logcat/domain/repositories/logcat_repository.dart (+1 more)
...
Cohesion: 0.25
Nodes (7): homeRepository, _initDeviceInfo, toggleAdbGrantMode, toggleDevOptions, toggleUsbDebugging, toggleWirelessDebugging, package:devkit/features/home/application/devkit_dashboard_state.dart

### Community 37 - "package:devkit/core/theme/app_theme.dart"
Cohesion: 0.40
Nodes (4): build, MyApp, new, package:devkit/core/theme/app_theme.dart
...
Cohesion: 0.40
Nodes (4): build, new, ToolsHeaderBarWidget, package:devkit/core/extensions/text_theme.dart

## Knowledge Gaps
- **282 isolated node(s):** `AppAssets`, `grid`, `_`, `sl`, `initServiceLocator` (+277 more)
...
- **Why does `ToolsCubit` connect `tools_screen_content_widget.dart` to `devkit_console_screen.dart`, `injection_container.dart`, `connect_command_card.dart`, `package:devkit/core/theme/app_theme.dart`, `StatelessWidget`?**
...
- **Should `header_widget.dart` be split into smaller, more focused modules?**
